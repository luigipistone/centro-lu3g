...
class CentroPageController extends Controller
{
    ...
    private function validatedModuleItemPayload(Request $request): array
    {
        return $request->validate([
            ...
            'available_components' => ['nullable', 'string', 'max:20000'],
            'decision_criteria' => ['nullable', 'string', 'max:20000'],
    ...
    private function moduleItemDatabasePayload(array $payload): array
    {
        return [
            ...
            'description' => $payload['description'] ?? null,
            'available_components' => $payload['available_components'] ?? null,
            'decision_criteria' => $payload['decision_criteria'] ?? null,
