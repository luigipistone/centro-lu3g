...
class RolePermissionService
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            ['group' => 'Fascicolo dipendente', 'key' => 'users.dossier.standard.view', 'label' => 'Visualizzare documenti ordinari del fascicolo'],
            ['group' => 'Fascicolo dipendente', 'key' => 'users.dossier.standard.manage', 'label' => 'Gestire documenti ordinari del fascicolo'],
            ['group' => 'Fascicolo dipendente', 'key' => 'users.dossier.contract.view', 'label' => 'Visualizzare dati contrattuali del fascicolo'],
            ['group' => 'Fascicolo dipendente', 'key' => 'users.dossier.contract.manage', 'label' => 'Gestire dati contrattuali del fascicolo'],
            ['group' => 'Fascicolo dipendente', 'key' => 'users.dossier.medical.status', 'label' => 'Visualizzare solo lo stato sanitario'],
            ['group' => 'Fascicolo dipendente', 'key' => 'users.dossier.medical.manage', 'label' => 'Gestire contenuti sanitari riservati'],
            ['group' => 'Fascicolo dipendente', 'key' => 'users.dossier.admin.view', 'label' => 'Visualizzare note amministrative riservate'],
            ['group' => 'Fascicolo dipendente', 'key' => 'users.dossier.admin.manage', 'label' => 'Gestire note amministrative riservate'],
